<?php
	$id = $_GET['id'];
	$qry = mysqli_query($conn, "SELECT * FROM kategori where kategori='$id'");
  ...
  <div id="primary-inner">
    ...
    <div id="main-content">
      <div class="main-content-header">
        <h2 class="main-content-title">Category 
          <span>
      ...
      <div class="layout-narrow">
        ...
        <?php
			$id = $_GET['id'];
			$qry2 = mysqli_query($conn, "SELECT * FROM games inner join keadaan on games.keadaan=keadaan.publish where kategori='$id' ORDER BY games.id DESC");
