...
?>
        <li id="menu-item-229" class="menu-item menu-item-type-taxonomy menu-item-object-post_tag menu-item-229">
          <a href="posting-web.php?id=<?php echo $data['kategori']; ?>">
            <font color="00bfff">
              <b>
...
<button type="button" class="btn btn-info btn-lg dw-gamez-login-register-show jump-regis" data-id="dw-gamez-login-modal-form" data-toggle="modal" data-target="#dw-gamez-login-register-modal" title="Login">Login</button>
  ...
  <section id="site-branding" class="site-branding">
    <div class="container">
      <div class="brand">
        <h2 class="site-title display-logo">
          <a href="index.php" title="DW Gamez" rel="home">
            <img alt="DW Gamez" src="data-web/images/logo.png" />
          </a>
        </h2>
      </div>
      <div class="search_form">
        <form role="search" method="get" class="search-form" action="search.php">
          <label>
            <span class="screen-reader-text sr-only">Search for:
            </span>
      ...
      <ul id="menu-main-menu" class="">
        ...
        <li id="menu-item-216" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-216">
          ...
          <ul class="sub-menu">
            ...
            <li id="menu-item-288" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-257">
              <a href="nintendo.php">NINTENDO
              </a>
            </li>
          </ul>
        </li>
		  <li id="menu-item-433" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-433">
          <a href="upcoming.php">Upcoming Games
          </a>
        </li>
