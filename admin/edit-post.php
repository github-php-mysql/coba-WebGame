              ...
              <div id="main-content">
				...
				<div class="dwqa-container" >
				  <form method="post" class="dwqa-content-ask-form" enctype="multipart/form-data">
					...
					<div class="col-sm-12">
					  <label for="author">
						<font color="blue">Search posting *
						</font>
					  </label>
					</div>
					...
					<div class="col-md-5 col-xs-6">
					<button class="btn btn-success btn-sm" type="submit" name="save" value="Can change">Search
					</button>
					</div>
					</div>
					</p>
								  ...
								  <tbody>
									...
									<tr>
									  ...
									  <td class="status text-center">
                                            ...
                                            <a href="edit-artikel-post.php?id=<?php echo $data['id']; ?>"><span data-toggle="tooltip" title="Edit Posting"><font color="#f2780a"><i class="fa fa-edit"></i></font></a> | 
