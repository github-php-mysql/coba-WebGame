              ...
              <div id="main-content">
                <article id="post-250" class="post-250 page type-page status-publish hentry">
                  <header class="page-header">
                    <h1 class="page-title">A total of visitors
                    </h1>
                  </header>
        ...
        <div class="accordion" id="accordion-dw_accordions-2">
          <div class="accordion-group">
            <div class="accordion-heading">
              <a class="accordion-toggle active" data-toggle="collapse" data-parent="#accordion-dw_accordions-2" href="#dw_accordions-2-meta-dw-widget-1">VISITORS
              </a>
            </div>
            <div id="dw_accordions-2-meta-dw-widget-1" class="widget_meta-dw-widget-1  accordion-body collapse in widget_meta">
              <div class="accordion-inner">
                ...
                <ul>
                  <li>
                    <a href="dashboard.php">A total of visitors
                    </a>
                  </li>
                  <li>
