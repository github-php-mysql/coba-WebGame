          ...
          <div id="primary">
            <div id="primary-inner">
              <div id="main-content">
                      ...
                      <div class="row gallery-page">
                        ...
                        <div id="wp-question-content-wrap" class="wp-core-ui wp-editor-wrap html-active">
                          ...
                          <div id="wp-question-content-editor-container" class="wp-editor-container">
                            ...
                            <textarea class="wp-editor-area" rows="5" cols="40" name="description" id="question-content"><?php echo $data['keterangan']; ?>
                            </textarea>
                          </div>
                        </div>
                        </p>
				...
				$sql_data = "update games set judul='".$title."', keterangan='".$description."', kategori='".$category."', type='".$type_games."', domain_game='".$domain_games."', ram='".$ram."', processor='".$processor."', memory='".$memory."',
							link='".$link."', link1='".$link1."', link2='".$link2."', link3='".$link3."', link4='".$link4."', link5='".$link5."', 
							gambar='".$image[0]."', gambar1='".$image[1]."', gambar2='".$image[2]."', gambar3='".$image[3]."', keadaan='".$publish1."' where id='".$id."'";
				if(mysqli_query($conn,$sql_data))
				{
					echo "<script>alert('Data di simpan');document.location='draft.php'</script>";
				}else{
					echo "<script>alert('Error');document.location='edit-artikel-draft.php'</script>";
				}
					mysqli_close($conn);
				}
